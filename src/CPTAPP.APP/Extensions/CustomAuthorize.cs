...
namespace CPTAPP.App.Extensions
{
    ...
    {
        public static bool ValidarClaimsUsurio(HttpContext context, string claimName, string claimValue)
        {
    ...
    public class RequisitoClaimFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if(!CustomAuthorization.ValidarClaimsUsurio(context.HttpContext, _claim.Type, _claim.Value))
            {
